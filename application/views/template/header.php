...
<html>
  <head>
    <meta charset="utf-8">
    <title>NLC</title>
        <link rel="stylesheet" href="<?php echo base_url(); ?>resources/css/flatly.bootstrap.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>resources/css/peserta_style.css">
        <script type="text/javascript" src="<?php echo base_url(); ?>resources/js/jquery-3.3.1.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>resources/js/peserta/peserta.js">
...
<div class="container">
  ...
  <div class="collapse navbar-collapse justify-content-end navbar-alt">
    <div class="navbar-nav">
      <a class="nav-item nav-link" href="#">Log Out<span class="sr-only">(current)</span></a>
    </div>
      </div>
</div>
